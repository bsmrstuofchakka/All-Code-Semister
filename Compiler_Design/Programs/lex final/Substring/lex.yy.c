...
static yyconst short int yy_base[12] =
    {   0,
        0,    0,    9,   10,    0,   10,    0,   10,   10,    6,
        4
    } ;

static yyconst short int yy_def[12] =
    {   0,
        9,    1,    9,    9,   10,    9,   11,    9,    0,    9,
        9
    } ;
...
char *yytext;
#line 1 "substring.txt"
#define INITIAL 0
#line 2 "substring.txt"
#include<stdio.h>
int sub=0;
int c;
int d;
...
case 1:
YY_RULE_SETUP
#line 8 "substring.txt"
{printf("is a substring");sub++;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 9 "substring.txt"

	YY_BREAK
case 3:
YY_RULE_SETUP
#line 10 "substring.txt"
ECHO;
	YY_BREAK
#line 623 "lex.yy.c"
